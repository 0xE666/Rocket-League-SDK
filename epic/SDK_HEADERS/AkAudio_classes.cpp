...
void UAkMusicDevice::EventTrackStart(int32_t PlayingID, struct FString FileMarker)
{
...
void UAkSoundSource::EventMarker(class UAkSoundSource* Source, int32_t PlayingID, struct FString Marker)
{
