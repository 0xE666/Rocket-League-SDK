...
struct FString UOnlineSubsystemEOS::eventFormatCurrency(struct FString Currency, int32_t Price)
{
...
void UOnlineSubsystemEOS::OpenStoreForItemsAsync(uint8_t LocalUserNum, TArray<struct FString> Targets, struct FScriptDelegate OnStorePurchaseCompleteDelegate)
{
...
void UOnlineSubsystemEOS::OpenStoreForItems(uint8_t LocalUserNum, TArray<struct FString> Targets)
{
...
void UOnlineSubsystemEOS::OpenPS4DisplayMode(uint8_t LocalUserNum, uint8_t DisplayMode, TArray<struct FString> Targets, int32_t ServiceLabel)
{
...
struct FString UOnlineSubsystemEOS::eventGetPlayerNicknameFromIndex(int32_t UserIndex)
{
...
void UOnlineSubsystemEOS::EventGetAppPriceInfoComplete(struct FName AppName, struct FString Price, struct FString DiscountPrice, int32_t DiscountPercentage)
{
...
bool UOnlinePersistentAuthInterfaceEOS::AuthWithNintendoAccountToken(uint8_t LocalUserNum, struct FString& NintendoAccountToken)
{
...
struct FString UOnlinePersistentAuthInterfaceEOS::GetContinuanceToken(uint8_t LocalUserNum)
{
...
bool UOnlinePersistentAuthInterfaceEOS::UseRefreshToken(uint8_t LocalUserNum, struct FString RefreshToken)
{
...
struct FString UOnlinePersistentAuthInterfaceEOS::GetRefreshToken(uint8_t LocalUserNum)
{
...
void UOnlinePlayerInterfaceEOS::EpicIDToPlatformIDCallback(struct FUniqueNetId PlatformAccountId, struct FString Error)
{
...
bool UOnlinePlayerInterfaceEOS::ShowInviteUI(uint8_t LocalUserNum, struct FString InviteText)
{
...
void UOnlinePlayerInterfaceEOS::SetRichPresence(uint8_t LocalUserNum, struct FString PresenceString, struct FString GameDataString)
{
...
bool UOnlinePlayerInterfaceEOS::RecordPlayersRecentlyMet(uint8_t LocalUserNum, struct FString GameDescription, TArray<struct FUniqueNetId>& Players)
{
...
struct FString UOnlinePlayerInterfaceEOS::GetPlayerLanguage(uint8_t LocalUserNum)
{
...
int32_t UOnlinePlayerInterfaceEOS::GetDeviceSelectionResults(uint8_t LocalUserNum, struct FString& DeviceName)
{
...
bool UOnlinePlayerInterfaceEOS::ShowCustomPlayersUI(uint8_t LocalUserNum, struct FString Title, struct FString Description, TArray<struct FUniqueNetId>& Players)
{
...
bool UOnlinePlayerInterfaceEOS::CanCommunicateVoice(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanCommunicateVideo(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanCommunicateText(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanShareUserCreatedContent(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanAccessPremiumVideoContent(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanAccessPremiumContent(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanUseCloudStorage(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanRecordDVRClips(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanBrowseInternet(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanShareWithSocialNetwork(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanShareKinectContent(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanUploadFitnessData(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::AddInGamePost(struct FString InPostID, uint8_t LocalUserNum, TArray<struct FString> StringReplaceList)
{
...
bool UOnlinePlayerInterfaceEOS::ShowCustomMessageUI(uint8_t LocalUserNum, struct FString MessageTitle, struct FString NonEditableMessage, struct FString EditableMessage, TArray<struct FUniqueNetId>& Recipients)
{
...
void UOnlinePlayerInterfaceEOS::OnRequestNativePlatformAuthTicketComplete(int32_t LocalUserNum, struct FString PlatformAuthTicket)
{
...
void UOnlinePlayerInterfaceEOS::RefreshConnectLogin(int32_t LocalUserNum)
{
	static UFunction* uFnRefreshConnectLogin = nullptr;

	if (!uFnRefreshConnectLogin)
	{
		uFnRefreshConnectLogin = UFunction::FindFunction("Function OnlineSubsystemEOS.OnlinePlayerInterfaceEOS.RefreshConnectLogin");
	}

	UOnlinePlayerInterfaceEOS_execRefreshConnectLogin_Params RefreshConnectLogin_Params;
	memcpy_s(&RefreshConnectLogin_Params.LocalUserNum, 0x4, &LocalUserNum, 0x4);

	uFnRefreshConnectLogin->FunctionFlags |= ~0x400;

	this->ProcessEvent(uFnRefreshConnectLogin, &RefreshConnectLogin_Params, nullptr);
...
void UOnlinePlayerInterfaceEOS::OnFriendMessageReceived(uint8_t LocalUserNum, struct FUniqueNetId SendingPlayer, struct FString SendingNick, struct FString Message)
{
...
void UOnlinePlayerInterfaceEOS::OnReceivedGameInvite(uint8_t LocalUserNum, struct FString InviterName)
{
...
bool UOnlinePlayerInterfaceEOS::SendGameInviteToFriends(uint8_t LocalUserNum, TArray<struct FUniqueNetId> Friends, struct FString Text)
{
...
bool UOnlinePlayerInterfaceEOS::SendGameInviteToFriend(uint8_t LocalUserNum, struct FUniqueNetId Friend, struct FString Text)
{
...
bool UOnlinePlayerInterfaceEOS::SendMessageToFriend(uint8_t LocalUserNum, struct FUniqueNetId Friend, struct FString Message)
{
	static UFunction* uFnSendMessageToFriend = nullptr;

	if (!uFnSendMessageToFriend)
	{
		uFnSendMessageToFriend = UFunction::FindFunction("Function OnlineSubsystemEOS.OnlinePlayerInterfaceEOS.SendMessageToFriend");
	}

	UOnlinePlayerInterfaceEOS_execSendMessageToFriend_Params SendMessageToFriend_Params;
...
void UOnlinePlayerInterfaceEOS::OnFriendInviteReceived(uint8_t LocalUserNum, struct FUniqueNetId RequestingPlayer, struct FString RequestingNick, struct FString Message)
{
...
bool UOnlinePlayerInterfaceEOS::AddFriendByName(uint8_t LocalUserNum, struct FString FriendName, struct FString Message)
{
...
bool UOnlinePlayerInterfaceEOS::QueryUserByDisplayName(uint8_t LocalUserNum, struct FString DisplayName)
{
...
bool UOnlinePlayerInterfaceEOS::AddFriend(uint8_t LocalUserNum, struct FUniqueNetId NewFriend, struct FString Message)
{
...
struct FString UOnlinePlayerInterfaceEOS::GetKeyboardInputResults(uint8_t& bWasCanceled)
{
...
bool UOnlinePlayerInterfaceEOS::ShowKeyboardUI(uint8_t LocalUserNum, struct FString TitleText, struct FString DescriptionText, unsigned long bIsPassword, unsigned long bShouldValidate, struct FString DefaultText, int32_t MaxResultLength)
{
...
bool UOnlinePlayerInterfaceEOS::CanShowPresenceInformation(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanViewPlayerProfiles(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanPurchaseContent(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanDownloadUserContent(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
bool UOnlinePlayerInterfaceEOS::CanPlayOnline(uint8_t LocalUserNum, unsigned long bAttemptToResolve, struct FString Reason, uint8_t& PrivilegeLevelHint)
{
...
struct FString UOnlinePlayerInterfaceEOS::GetPlayerNickname(uint8_t LocalUserNum)
{
...
void UOnlinePlayerInterfaceEOS::OnReceievedPinGrantCode(uint8_t Result, uint8_t LocalUserNum, struct FString Code, struct FString URL, int32_t SecondsUntilExpiration)
{
...
bool UOnlinePlayerInterfaceEOS::Login(uint8_t LocalUserNum, struct FString LoginName, struct FString Password, unsigned long bWantsLocalOnly)
{
...
bool UOnlineUserCloudFileInterfaceEOS::WriteUserFile(struct FString UserId, struct FString Filename, TArray<uint8_t>& FileContents)
{
...
bool UOnlineUserCloudFileInterfaceEOS::GetFileContents(struct FString UserId, struct FString Filename, TArray<uint8_t>& FileContents)
{
...
// struct FString                 LocalEpicAccountId             (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
// struct FString                 TargetEpicAccountId            (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
// struct FString                 RoomName                       (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)

void UOnlineVoiceInterfaceEOS::SetPlayerBlockStatus(unsigned long bBlocked, struct FString& LocalEpicAccountId, struct FString& TargetEpicAccountId, struct FString& RoomName)
{
...
void UOnlineVoiceInterfaceEOS::SetPlayerMuteStatus(unsigned long bMuted, struct FString& LocalEpicAccountId, struct FString& TargetEpicAccountId, struct FString& RoomName)
{
...
// Parameter info:
// uint8_t                        ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// struct FString                 EpicAccountId                  (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)

uint8_t UOnlineVoiceInterfaceEOS::GetUserState(struct FString& EpicAccountId)
{
...
struct FString UOnlineVoiceInterfaceEOS::GetCurrentRoomNameForUser(struct FString& EpicAccountId)
{
...
bool UOnlineVoiceInterfaceEOS::LeaveVoiceRoom(struct FString& EpicAccountId, struct FString& RoomName)
{
...
// struct FString                 EpicAccountId                  (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
// struct FString                 RoomName                       (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
// struct FString                 ClientBaseUrl                  (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
// struct FString                 JoinToken                      (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)

bool UOnlineVoiceInterfaceEOS::JoinVoiceRoom(struct FString& EpicAccountId, struct FString& RoomName, struct FString& ClientBaseUrl, struct FString& JoinToken)
{
...
// struct FString                 EpicAccountId                  (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
// struct FString                 DeviceID                       (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)

bool UOnlineVoiceInterfaceEOS::SetAudioOutputDevice(float OutputVolume, struct FString& EpicAccountId, struct FString& DeviceID)
{
...
bool UOnlineVoiceInterfaceEOS::SetAudioInputDevice(float InputVolume, struct FString& EpicAccountId, struct FString& DeviceID)
{
...
// struct FString                 PlatformId                     (CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)

void UOnlineVoiceInterfaceEOS::SetLocalPlayerRegisteredStatus(unsigned long bRegister, struct FString& PlatformId)
{
...
// [0x00120001] (FUNC_Final | FUNC_Public | FUNC_Delegate | FUNC_AllFlags)
// Parameter info:
// struct FString                 EpicAccountId                  (CPF_Parm | CPF_NeedCtorLink)
// struct FString                 RoomName                       (CPF_Parm | CPF_NeedCtorLink)
// struct FVoiceRoomMemberStatus  MemberStatus                   (CPF_Parm)

void UOnlineVoiceInterfaceEOS::EventPlayerStatusChanged(struct FString EpicAccountId, struct FString RoomName, struct FVoiceRoomMemberStatus MemberStatus)
{
...
void UOnlineVoiceInterfaceEOS::EventPlayerLeftVoiceRoom(struct FString EpicAccountId, struct FString RoomName)
{
...
void UOnlineVoiceInterfaceEOS::EventPlayerJoinedVoiceRoom(struct FString EpicAccountId, struct FString RoomName)
{
...
void UOnlineVoiceInterfaceEOS::EventRemovedFromVoiceRoom(struct FString EpicAccountId, struct FString RoomName, uint8_t RemovedResult)
{
...
void UOnlineVoiceInterfaceEOS::EventJoinedVoiceRoom(struct FString EpicAccountId, struct FString RoomName, uint8_t JoinResult)
{
...
void UOnlineVoiceInterfaceEOS::EventLeftVoiceRoom(struct FString EpicAccountId, struct FString RoomName, uint8_t LeaveResult)
{
...
// Function OnlineSubsystemEOS.__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538.__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538
// [0x00020003] (FUNC_Final | FUNC_RequiredAPI | FUNC_Public | FUNC_AllFlags)
// Parameter info:
// int32_t                        _                              (CPF_Parm)
// struct FString                 PlatformAuthTicket             (CPF_Parm | CPF_NeedCtorLink)

void U__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538::__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538(int32_t _, struct FString PlatformAuthTicket)
{
	static UFunction* uFn__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538 = nullptr;

	if (!uFn__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538)
	{
		uFn__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538 = UFunction::FindFunction("Function OnlineSubsystemEOS.__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538.__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538");
	}

	U__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538_exec__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538_Params __OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538_Params;
	memcpy_s(&__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538_Params._, 0x4, &_, 0x4);
	memcpy_s(&__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538_Params.PlatformAuthTicket, 0x10, &PlatformAuthTicket, 0x10);

	this->ProcessEvent(uFn__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538, &__OnlinePlayerInterfaceEOS__LinkedAccount_2FA5512A4E5356722DD5479B425A4538_Params, nullptr);
};

// Function OnlineSubsystemEOS.__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2.__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2
// [0x00020003] (FUNC_Final | FUNC_RequiredAPI | FUNC_Public | FUNC_AllFlags)
// Parameter info:
// unsigned long                  bSuccess                       (CPF_Parm)
// struct FString                 Code                           (CPF_Parm | CPF_NeedCtorLink)

void U__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2::__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2(unsigned long bSuccess, struct FString Code)
{
	static UFunction* uFn__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2 = nullptr;

	if (!uFn__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2)
	{
		uFn__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2 = UFunction::FindFunction("Function OnlineSubsystemEOS.__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2.__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2");
	}

	U__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2_exec__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2_Params __OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2_Params;
	__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2_Params.bSuccess = bSuccess;
	memcpy_s(&__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2_Params.Code, 0x10, &Code, 0x10);

	this->ProcessEvent(uFn__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2, &__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_8B525AF64E91E4581EBEF186F52568D2_Params, nullptr);
};
