...
public:
	...
	void __Subscription__TriggerAll_DFEA523C4EDE36083E16FD97B2A044D4(class USubscription* S);
...
// Class Core.__AsyncTask__All_D7D9C6D540AF5025CB43348168DEA7E4
// 0x0010 (0x0060 - 0x0070)
class U__AsyncTask__All_D7D9C6D540AF5025CB43348168DEA7E4 : public UObject
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class Core.__AsyncTask__All_D7D9C6D540AF5025CB43348168DEA7E4");
		}

		return uClassPointer;
	};

	void __AsyncTask__All_D7D9C6D540AF5025CB43348168DEA7E4();
};
