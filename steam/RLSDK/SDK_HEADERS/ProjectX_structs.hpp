...
struct FReservationData
{
	...
	uint8_t                                           UnknownData00[0x8];                               // 0x00D0 (0x0008) FIX WRONG SIZE OF PREVIOUS PROPERTY [Original: 0x0010, Missing: 0x0008]
...
{
	uint64_t                                           ServerId;                                         		// 0x0000 (0x0008) [0x0000000000000000]               
	int32_t                                            Playlist;                                         		// 0x0008 (0x0004) [0x0000000000000000]               
	int32_t                                            WinningTeam;                                      		// 0x000C (0x0004) [0x0000000000000000]               
	int32_t                                            Team0Score;                                       		// 0x0010 (0x0004) [0x0000000000000000]               
	int32_t                                            Team1Score;                                       		// 0x0014 (0x0004) [0x0000000000000000]               
...
struct FSkillMatchPlayer
{
	...
	int32_t                                            PartyID;                                          		// 0x0050 (0x0004) [0x0000000000000000]               
	int32_t                                            Score;                                            		// 0x0054 (0x0004) [0x0000000000000000]               
	int32_t                                            Team;                                             		// 0x0058 (0x0004) [0x0000000000000000]               
};
...
struct FPartyJoinMatchSettings
{
	...
	struct FString                                     BeaconAddress;                                    		// 0x0010 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	int32_t                                            PlaylistId;                                       		// 0x0020 (0x0004) [0x0000000000000000]               
...
struct FPartyMemberServer
{
	...
	int32_t                                            PlaylistId;                                       		// 0x0050 (0x0004) [0x0000000000000000]               
};
...
struct FPartyMember
{
	...
	struct FUniqueLobbyId                              PlatformParty;                                    		// 0x0168 (0x0010) [0x0001000000000000]               
};
...
struct FSetPlayerStorageRequestItem
{
	...
	struct FString                                     Data;                                             		// 0x0010 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
...
{
	struct FString                                     PartyID;                                          		// 0x0000 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
	...
	struct FString                                     JoinID;                                           		// 0x0060 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
};
...
struct FFileUploadData
{
	...
	uint8_t                                            TruncateType;                                     		// 0x0038 (0x0001) [0x0000000000000000]               
};
...
{
	struct FString                                     Class;                                            		// 0x0000 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FString                                     Property;                                         		// 0x0010 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
{
	struct FString                                     AccountId;                                        		// 0x0000 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
	struct FString                                     Created;                                          		// 0x0010 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
	unsigned long                                      Favorite : 1;                                     		// 0x0020 (0x0004) [0x0001000000000000] [0x00000001] 
	struct FString                                     NickName;                                         		// 0x0028 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
};
...
{
	struct FString                                     ReceiveInvites;                                   		// 0x0000 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
};
...
{
	struct FPrivacySettings                            Privacy;                                          		// 0x0000 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
};
...
// ScriptStruct ProjectX.EpicConfig_X.PermissionPair
// 0x0011
struct FPermissionPair
{
	struct FString                                     PermissionLabel;                                  		// 0x0000 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
struct FFXAttachment
{
	...
	unsigned long                                      bExistingComponent : 1;                           		// 0x0094 (0x0004) [0x0000000800000000] [0x00000008] 
	unsigned long                                      bExistingAttachment : 1;                          		// 0x0094 (0x0004) [0x0000000800000000] [0x00000010] 
	float                                              AttachedTime;                                     		// 0x0098 (0x0004) [0x0000000000002000] (CPF_Transient)
	uint8_t                                            State;                                            		// 0x009C (0x0001) [0x0000000000002000] (CPF_Transient)
	...
	int32_t                                            BoneIndex;                                        		// 0x00F0 (0x0004) [0x0000000000002000] (CPF_Transient)
...
struct FCheckReplacementDedicatedServerData
{
	...
	int32_t                                            Port;                                             		// 0x0028 (0x0004) [0x0000000000000000]               
};
...
struct FPendingReservation
{
	...
	uint8_t                                           UnknownData00[0x8];                               // 0x0008 (0x0008) FIX WRONG SIZE OF PREVIOUS PROPERTY [Original: 0x0010, Missing: 0x0008]
...
struct FPsyNetPartyMember
{
	...
	struct FString                                     Username;                                         		// 0x0058 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
	uint64_t                                           JoinedAt;                                         		// 0x0068 (0x0008) [0x0001000000000000]               
	struct FString                                     Role;                                             		// 0x0070 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
};
...
struct FPartyInvite
{
	...
	struct FString                                     Username;                                         		// 0x0048 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
	struct FString                                     PartyID;                                          		// 0x0058 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
...
struct FFindPrivateServerResult
{
	...
	int32_t                                            Port;                                             		// 0x00C0 (0x0004) [0x0000000000000000]               
};
