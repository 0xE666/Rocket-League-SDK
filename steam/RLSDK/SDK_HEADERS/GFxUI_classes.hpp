...
public:
	...
	int32_t ActionScriptInt(struct FString Path);
	...
	bool SetVariableStringArray(struct FString Path, int32_t Index, TArray<struct FString> Arg);
	bool SetVariableFloatArray(struct FString Path, int32_t Index, TArray<float> Arg);
	bool SetVariableIntArray(struct FString Path, int32_t Index, TArray<int32_t> Arg);
	bool SetVariableArray(struct FString Path, int32_t Index, TArray<struct FASValue> Arg);
	bool GetVariableStringArray(struct FString Path, int32_t Index, TArray<struct FString>& Arg);
	bool GetVariableFloatArray(struct FString Path, int32_t Index, TArray<float>& Arg);
	bool GetVariableIntArray(struct FString Path, int32_t Index, TArray<int32_t>& Arg);
	bool GetVariableArray(struct FString Path, int32_t Index, TArray<struct FASValue>& Arg);
	...
	void SetVariableInt(struct FString Path, int32_t I);
	...
	int32_t GetVariableInt(struct FString Path);
...
public:
	...
	bool eventWidgetUnloaded(struct FName WidgetName, struct FName WidgetPath, class UGFxObject* Widget);
	bool eventWidgetInitialized(struct FName WidgetName, struct FName WidgetPath, class UGFxObject* Widget);
	class UGFxObject* AttachMovie(struct FString symbolname, struct FString instancename, int32_t Depth, class UClass* Type);
	class UGFxObject* CreateEmptyMovieClip(struct FString instancename, int32_t Depth, class UClass* Type);
	...
	int32_t ActionScriptInt(struct FString method);
	...
	void SetElementMemberString(int32_t Index, struct FString Member, struct FString S);
	void SetElementMemberInt(int32_t Index, struct FString Member, int32_t I);
	void SetElementMemberFloat(int32_t Index, struct FString Member, float F);
	void SetElementMemberBool(int32_t Index, struct FString Member, unsigned long B);
	void SetElementMemberObject(int32_t Index, struct FString Member, class UGFxObject* val);
	void SetElementMember(int32_t Index, struct FString Member, struct FASValue Arg);
	struct FString GetElementMemberString(int32_t Index, struct FString Member);
	int32_t GetElementMemberInt(int32_t Index, struct FString Member);
	float GetElementMemberFloat(int32_t Index, struct FString Member);
	bool GetElementMemberBool(int32_t Index, struct FString Member);
	class UGFxObject* GetElementMemberObject(int32_t Index, struct FString Member, class UClass* Type);
	struct FASValue GetElementMember(int32_t Index, struct FString Member);
	...
	void SetElementString(int32_t Index, struct FString S);
	...
	struct FString GetElementString(int32_t Index);
	...
	void SetInt(struct FString Member, int32_t I);
	...
	int32_t GetInt(struct FString Member);
...
public:
	...
	void AS3AddEventListener(struct FString Type, class UGFxObject* O, unsigned long useCapture, int32_t listenerPriority, unsigned long useWeakReference);
