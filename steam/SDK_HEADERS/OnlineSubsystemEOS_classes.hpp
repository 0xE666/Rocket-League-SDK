...
// Class OnlineSubsystemEOS.__OnlinePlayerInterfaceEOS__LinkedAccount_A96D912747906354A21618AAE9E37A71
// 0x0004 (0x0060 - 0x0064)
class U__OnlinePlayerInterfaceEOS__LinkedAccount_A96D912747906354A21618AAE9E37A71 : public UObject
{
public:
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class OnlineSubsystemEOS.__OnlinePlayerInterfaceEOS__LinkedAccount_A96D912747906354A21618AAE9E37A71");
		}

		return uClassPointer;
	};

	void __OnlinePlayerInterfaceEOS__LinkedAccount_A96D912747906354A21618AAE9E37A71(int32_t _, struct FString PlatformAuthTicket);
};

// Class OnlineSubsystemEOS.__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_5BBAA39044BD570F9A5C4E91134253D1
// 0x0020 (0x0060 - 0x0080)
class U__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_5BBAA39044BD570F9A5C4E91134253D1 : public UObject
{
public:
	int32_t                                            LocalUserNum;                                  // 0x0060 (0x0004) [0x0000000000000000]               
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class OnlineSubsystemEOS.__OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_5BBAA39044BD570F9A5C4E91134253D1");
		}

		return uClassPointer;
	};

	void __OnlinePlayerInterfaceEOS__RequestNativePlatformAuthTicket_5BBAA39044BD570F9A5C4E91134253D1(unsigned long bSuccess, struct FString Code);
};
